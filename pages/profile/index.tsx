...
const Profile:NextPage = () => {
    ...
    return (
        <div className='box-border overflow-y-scroll snap-y snap-mandatory scrollbar-hide scroll-pt-6'>
            ...
            <section className="w-[100%] h-[55vh]  snap-center flex flex-col items-center justify-center pt-[10vh] sm:flex-row sm:items-start sm:pt-[12vh]">
                <div className="w-[100%] h-[80%] flex ">
                    {/*---------------- first column with image and follow section starts here -----------------------*/}
                    <div className="w-[55%] h-[100%] flex flex-col items-center justify-center sm:w-[40%]">
                        <div className="w-[100%] h-[100%] flex flex-col items-center justify-center mr-3 mb-0 sm:mb-5">
                            <img src="/Assets/icons/avatar.png" alt="" className="w-[60%] sm:w-[45%]" />
                            {/*-------- update profile image button starts here ------*/}
                            <div className="w-[50%] h-[15%] rounded-[10px] bg-[#323c71] flex items-center justify-center sm:w-[30%] sm:h-[20%] sm:mb-[1vh]">
                                <span className="text-white">Edit image</span>
                            </div>
                            {/*-------- update profile image button starts here ------*/}

                        </div>
                        <div className="w-[100%] h-[20%] flex items-center justify-evenly box-border box-border pl-9">
                    ...
                    <div className="w-[50%] h-[100%] flex flex-col items-start justify-start pl-4 ">
            ...
            <section className="w-[100%] h-screen snap-center box-border pb-[10vh]">
