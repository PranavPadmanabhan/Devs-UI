...
const Challenge: NextPage = (challenges) => {
    ...
    return (
        <div className='w-screen flex flex-col items-center justify-start pt-[10vh] box-border overflow-y-scroll snap-y snap-mandatory scrollbar-hide sm:snap-none '>
            <NavBar />
            <div className="flex flex-col items-center justify-start sm:flex-row sm:items-center justify-center sm:box-border sm:px-[5%]">
                <div className="flex flex-col items-center justify-start w-screen h-[60%] px-[5%] min-h-[60vh] box-border snap-center sm:w-[50%] sm:h-[50%] ">
                    <div className="flex items-center w-[100%] justify-between">
                        <div className="self-start my-[10px] flex items-center justify-between w-[35%] h-[10%] max-h-[30px] pl-[5px] border-[1px] border-gray-300 rounded-[8px] sm:w-[25%] sm:h-[25%] sm:max-h-[40px] sm:ml-[7%] sm:mb-[5%]">
                    ...
                    <div className="w-screen h-[100%] flex  overflow-x-scroll  snap-x snap-mandatory px-[7%] scrollbar-hide sm:h-[90%] sm:w-[100%] sm:mb-[5vh]">
                        {
                ...
                <div className="flex flex-col w-screen  box-border snap-center sm:w-[50%]">
                    <h1 className="ml-[5%] text-[10vw] font-light self-start my-[7px] sm:text-[4vw]">{currentElement.name}</h1>
                    <span className="ml-[5%] max-w-[90%] text-[4vw] font-light sm:text-[1vw]">{currentElement.description}</span>
                    <div className="pl-[5%] w-screen h-[13vh] flex items-center box-border sm:w-[60%]">
                        ...
                        <div className=" flex flex-col w-[50%] items-start justify-center h-[100%] sm:w-[60%] sm:ml-[3%]">
                            <span className="text-[6vw] sm:text-[1.6vw] font-semibold">{currentElement.author}</span>
                            <div className="w-[60%] h-[30%] bg-[#333c73] flex items-center justify-center rounded-[10px] sm:mt-[5px] sm:w-[50%] sm:min-w-[100px] sm:max-h-[40px] sm:h-[35%]">
                                <span className="text-white text-[4vw] sm:text-[1vw] font-semibold">Visit Profile</span>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col items-start justify-start box-border sm:w-[50%]">
                    ...
                    <div className="my-[2vh] w-[100%] min-h-[10vh] flex items-center justify-evenly box-border">
