...
function Header() {
  ...
  return (
    <div className={`w-screen h-screen box-border flex flex-col items-center justify-start p-[15px] pt-[10vh] snap-center bg-${preferredTheme.backgroundImage.portrait} bg-no-repeat bg-cover bg-center sm:flex-row sm:bg-${preferredTheme.backgroundImage.landscape} sm:bg-cover`}>
      <NavBar />
      ...
      <div className="flex flex-col items-start h-[50%] sm:order-2 sm:w-[40%] sm:h-[80%] sm:flex-col-reverse sm:justify-end sm:pl-[2%]">
        ...
        <div className="self-center w-[80%] h-[15%] max-h-[50px] min-h-[40] flex items-center justify-center bg-black rounded-[25px] mt-[5%] sm:self-start sm:w-[70%]">
