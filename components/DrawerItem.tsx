...
function DrawerItem({ url, title, redAccent, onClick, upcoming }: drawerProps) {
    return (
        <div onClick={onClick} className={`${styles.DrawerItem} w-[100%] h-[13%] my-[4px] cursor-pointer flex items-center justify-between box-border px-[15px] sm:h-[20%]`}>
