...
function DesignCard() {
  return (
    <div className={`${styles.DesignCard} cursor-pointer self-center w-[85%] h-[60vh] flex-none  snap-center rounded-[20px] shadow-task p-[5%] flex flex-col sm:h-[65vh] sm:max-h-[600px] sm:rounded-[25px] sm:w-[85%] my-[10px]  sm:hover:scale-110 duration-700`}>
