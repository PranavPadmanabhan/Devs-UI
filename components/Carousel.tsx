...
function Carousel() {
    return (
        <div className="flex w-[100vw] h-[70vh] items-center justify-start box-border overflow-x-scroll snap-x snap-mandatory px-[2%] scroll-px-4 scrollbar-hide sm:overflow-x-hidden sm:grid sm:grid-cols-3 sm:h-[80vh] sm:place-content-start sm:px-[5%] sm:gap-y-[50px]">
